...
const GrafikPemeliharaan = () => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onValue(pemeliharaanRef, (snapshot) => {
    ...
    return (
        ...
        <div className="card">
            <div className="card-body">
                <div style={{ color: 'black', fontSize: '20px' }}>Grafik Data Pemeliharaan</div>
            <div className="mb-3">
                <select
...
export default GrafikPemeliharaan;
